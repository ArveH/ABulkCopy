...
public class CmdArguments
{
    ...
    [Option("to-lower", Required = false, HelpText = "When importing tables, all identifiers (table names, column names, etc.) will be converted to lowercase. This parameter is only used when direction = In")]
